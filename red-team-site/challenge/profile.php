...
<div class="section-padding">
    <div class="container-custom">
        ...
        <?php if (isset($_SESSION['escalated']) && $_SESSION['escalated'] === true): ?>
            <div class="alert alert-success mb-4"
                style="background: rgba(0,255,0,0.1); border: 1px solid rgba(0,255,0,0.3);">
                <strong>🎉 Privilege Escalation Successful!</strong><br>
                You tampered with the hidden <code>role</code> parameter to gain admin access.<br>
                Flag: <code>CCEE{pr1v_3sc_r0l3_t4mp3r1ng}</code>
            </div>
            <?php unset($_SESSION['escalated']); ?>
        <?php endif; ?>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6">
                <div class="bento-card p-5">
                    ...
                    <div class="mb-4">
                        <p class="text-secondary">Current Balance: <span
                                class="text-success fw-bold">$<?php echo $user['credits']; ?></span></p>
                        <p class="text-secondary">Role: <span
                                class="badge <?php echo $user['role'] === 'admin' ? 'bg-danger' : 'bg-secondary'; ?>"><?php echo htmlspecialchars($user['role']); ?></span>
                        </p>
                    </div>
                    <form method="POST" action="profile.php">
                        <div class="mb-3">
